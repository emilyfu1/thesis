...
parents_unres_within_merged = systemfit(eqns_within, method = "SUR", 
                                    data = parents_est_data_merged)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_unres_r_within_merged = systemfit(eqns_r_within, method = "SUR", 
                                      data = parents_est_data_merged)

### No restrictions on coefficients: deviations from average of men AND women

# leisure including eating, drinking, washing
parents_unres_between_merged = systemfit(eqns_between, method = "SUR", 
                                     data = parents_est_data_merged)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_unres_r_between_merged = systemfit(eqns_r_between, method = "SUR", 
                                       data = parents_est_data_merged)

### No restrictions on coefficients: deviations from average of opposite sex

# leisure including eating, drinking, washing
parents_unres_opposite_merged = systemfit(eqns_opposite, method = "SUR", 
                                      data = parents_est_data_merged)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_unres_r_opposite_merged = systemfit(eqns_opposite, method = "SUR", 
                                        data = parents_est_data_merged)

### Restricted coefficients, deviations from average with own sex

# leisure including eating, drinking, washing
parents_res_within_merged = systemfit(eqns_within, method = "SUR", 
                                  data = parents_est_data_merged,
                                  restrict.regMat = modReg_within)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_res_r_within_merged = systemfit(eqns_r_within, method = "SUR", 
                                    data = parents_est_data_merged, 
                                    restrict.regMat = modReg_within)
...
# leisure including eating, drinking, washing
parents_res_between_merged = systemfit(eqns_between, method = "SUR", 
                                   data = parents_est_data_merged,
                                   restrict.regMat = modReg_between)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_res_r_between_merged = systemfit(eqns_r_between, method = "SUR", 
                                     data = parents_est_data_merged,
                                     restrict.regMat = modReg_between)
...
# leisure including eating, drinking, washing
parents_res_opposite_merged = systemfit(eqns_opposite, method = "SUR", 
                                    data = parents_est_data_merged,
                                    restrict.regMat = modReg_opposite)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_res_r_opposite_merged = systemfit(eqns_r_opposite, method = "SUR", 
                                      data = parents_est_data_merged,
                                      restrict.regMat = modReg_opposite)
...
# leisure including eating, drinking, washing
parents_unres_within_2015 = systemfit(eqns_within, method = "SUR", 
                                  data = parents_est_data_2015)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_unres_r_within_2015 = systemfit(eqns_r_within, method = "SUR", 
                                    data = parents_est_data_2015)

### No restrictions on coefficients: deviations from average of men AND women

# leisure including eating, drinking, washing
parents_unres_between_2015 = systemfit(eqns_between, method = "SUR", 
                                   data = parents_est_data_2015)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_unres_r_between_2015 = systemfit(eqns_r_between, method = "SUR", 
                                     data = parents_est_data_2015)

### No restrictions on coefficients: deviations from average of opposite sex

# leisure including eating, drinking, washing
parents_unres_opposite_2015 = systemfit(eqns_opposite, method = "SUR", 
                                    data = parents_est_data_2015)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_unres_r_opposite_2015 = systemfit(eqns_opposite, method = "SUR", 
                                      data = parents_est_data_2015)

### Restricted coefficients, deviations from average with own sex

# leisure including eating, drinking, washing
parents_res_within_2015 = systemfit(eqns_within, method = "SUR", 
                                data = parents_est_data_2015,
                                restrict.regMat = modReg_within)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_res_r_within_2015 = systemfit(eqns_r_within, method = "SUR", 
                                  data = parents_est_data_2015, 
                                  restrict.regMat = modReg_within)
...
# leisure including eating, drinking, washing
parents_res_between_2015 = systemfit(eqns_between, method = "SUR", 
                                 data = parents_est_data_2015,
                                 restrict.regMat = modReg_between)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_res_r_between_2015 = systemfit(eqns_r_between, method = "SUR", 
                                   data = parents_est_data_2015,
                                   restrict.regMat = modReg_between)
...
# leisure including eating, drinking, washing
parents_res_opposite_2015 = systemfit(eqns_opposite, method = "SUR", 
                                  data = parents_est_data_2015,
                                  restrict.regMat = modReg_opposite)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_res_r_opposite_2015 = systemfit(eqns_r_opposite, method = "SUR", 
                                    data = parents_est_data_2015,
                                    restrict.regMat = modReg_opposite)
...
# leisure including eating, drinking, washing
parents_unres_within_2000 = systemfit(eqns_within, method = "SUR", 
                                  data = parents_est_data_2000)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_unres_r_within_2000 = systemfit(eqns_r_within, method = "SUR", 
                                    data = parents_est_data_2000)

### No restrictions on coefficients: deviations from average of men AND women

# leisure including eating, drinking, washing
parents_unres_between_2000 = systemfit(eqns_between, method = "SUR", 
                                   data = parents_est_data_2000)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_unres_r_between_2000 = systemfit(eqns_r_between, method = "SUR", 
                                     data = parents_est_data_2000)

### No restrictions on coefficients: deviations from average of opposite sex

# leisure including eating, drinking, washing
parents_unres_opposite_2000 = systemfit(eqns_opposite, method = "SUR", 
                                    data = parents_est_data_2000)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_unres_r_opposite_2000 = systemfit(eqns_opposite, method = "SUR", 
                                      data = parents_est_data_2000)

### Restricted coefficients, deviations from average with own sex

# leisure including eating, drinking, washing
parents_res_within_2000 = systemfit(eqns_within, method = "SUR", 
                                data = parents_est_data_2000,
                                restrict.regMat = modReg_within)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_res_r_within_2000 = systemfit(eqns_r_within, method = "SUR", 
                                  data = parents_est_data_2000, 
                                  restrict.regMat = modReg_within)
...
# leisure including eating, drinking, washing
parents_res_between_2000 = systemfit(eqns_between, method = "SUR", 
                                 data = parents_est_data_2000,
                                 restrict.regMat = modReg_between)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_res_r_between_2000 = systemfit(eqns_r_between, method = "SUR", 
                                   data = parents_est_data_2000,
                                   restrict.regMat = modReg_between)
...
# leisure including eating, drinking, washing
parents_res_opposite_2000 = systemfit(eqns_opposite, method = "SUR", 
                                  data = parents_est_data_2000,
                                  restrict.regMat = modReg_opposite)
# relaxing, socialising, sport, entertainment, and hobbies only
parents_res_r_opposite_2000 = systemfit(eqns_r_opposite, method = "SUR", 
                                    data = parents_est_data_2000,
                                    restrict.regMat = modReg_opposite)
...
# leisure including eating, drinking, washing
nonparents_unres_within_merged = systemfit(eqns_within, method = "SUR", 
                                    data = nonparents_est_data_merged)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_unres_r_within_merged = systemfit(eqns_r_within, method = "SUR", 
                                      data = nonparents_est_data_merged)

### No restrictions on coefficients: deviations from average of men AND women

# leisure including eating, drinking, washing
nonparents_unres_between_merged = systemfit(eqns_between, method = "SUR", 
                                     data = nonparents_est_data_merged)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_unres_r_between_merged = systemfit(eqns_r_between, method = "SUR", 
                                       data = nonparents_est_data_merged)

### No restrictions on coefficients: deviations from average of opposite sex

# leisure including eating, drinking, washing
nonparents_unres_opposite_merged = systemfit(eqns_opposite, method = "SUR", 
                                      data = nonparents_est_data_merged)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_unres_r_opposite_merged = systemfit(eqns_opposite, method = "SUR", 
                                        data = nonparents_est_data_merged)

### Restricted coefficients, deviations from average with own sex

# leisure including eating, drinking, washing
nonparents_res_within_merged = systemfit(eqns_within, method = "SUR", 
                                  data = nonparents_est_data_merged,
                                  restrict.regMat = modReg_within)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_res_r_within_merged = systemfit(eqns_r_within, method = "SUR", 
                                    data = nonparents_est_data_merged, 
                                    restrict.regMat = modReg_within)
...
# leisure including eating, drinking, washing
nonparents_res_between_merged = systemfit(eqns_between, method = "SUR", 
                                   data = nonparents_est_data_merged,
                                   restrict.regMat = modReg_between)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_res_r_between_merged = systemfit(eqns_r_between, method = "SUR", 
                                     data = nonparents_est_data_merged,
                                     restrict.regMat = modReg_between)
...
# leisure including eating, drinking, washing
nonparents_res_opposite_merged = systemfit(eqns_opposite, method = "SUR", 
                                    data = nonparents_est_data_merged,
                                    restrict.regMat = modReg_opposite)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_res_r_opposite_merged = systemfit(eqns_r_opposite, method = "SUR", 
                                      data = nonparents_est_data_merged,
                                      restrict.regMat = modReg_opposite)
...
# leisure including eating, drinking, washing
nonparents_unres_within_2015 = systemfit(eqns_within, method = "SUR", 
                                  data = nonparents_est_data_2015)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_unres_r_within_2015 = systemfit(eqns_r_within, method = "SUR", 
                                    data = nonparents_est_data_2015)

### No restrictions on coefficients: deviations from average of men AND women

# leisure including eating, drinking, washing
nonparents_unres_between_2015 = systemfit(eqns_between, method = "SUR", 
                                   data = nonparents_est_data_2015)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_unres_r_between_2015 = systemfit(eqns_r_between, method = "SUR", 
                                     data = nonparents_est_data_2015)

### No restrictions on coefficients: deviations from average of opposite sex

# leisure including eating, drinking, washing
nonparents_unres_opposite_2015 = systemfit(eqns_opposite, method = "SUR", 
                                    data = nonparents_est_data_2015)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_unres_r_opposite_2015 = systemfit(eqns_opposite, method = "SUR", 
                                      data = nonparents_est_data_2015)

### Restricted coefficients, deviations from average with own sex

# leisure including eating, drinking, washing
nonparents_res_within_2015 = systemfit(eqns_within, method = "SUR", 
                                data = nonparents_est_data_2015,
                                restrict.regMat = modReg_within)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_res_r_within_2015 = systemfit(eqns_r_within, method = "SUR", 
                                  data = nonparents_est_data_2015, 
                                  restrict.regMat = modReg_within)
...
# leisure including eating, drinking, washing
nonparents_res_between_2015 = systemfit(eqns_between, method = "SUR", 
                                 data = nonparents_est_data_2015,
                                 restrict.regMat = modReg_between)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_res_r_between_2015 = systemfit(eqns_r_between, method = "SUR", 
                                   data = nonparents_est_data_2015,
                                   restrict.regMat = modReg_between)
...
# leisure including eating, drinking, washing
nonparents_res_opposite_2015 = systemfit(eqns_opposite, method = "SUR", 
                                  data = nonparents_est_data_2015,
                                  restrict.regMat = modReg_opposite)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_res_r_opposite_2015 = systemfit(eqns_r_opposite, method = "SUR", 
                                    data = nonparents_est_data_2015,
                                    restrict.regMat = modReg_opposite)
...
# leisure including eating, drinking, washing
nonparents_unres_within_2000 = systemfit(eqns_within, method = "SUR", 
                                  data = nonparents_est_data_2000)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_unres_r_within_2000 = systemfit(eqns_r_within, method = "SUR", 
                                    data = nonparents_est_data_2000)

### No restrictions on coefficients: deviations from average of men AND women

# leisure including eating, drinking, washing
nonparents_unres_between_2000 = systemfit(eqns_between, method = "SUR", 
                                   data = nonparents_est_data_2000)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_unres_r_between_2000 = systemfit(eqns_r_between, method = "SUR", 
                                     data = nonparents_est_data_2000)

### No restrictions on coefficients: deviations from average of opposite sex

# leisure including eating, drinking, washing
nonparents_unres_opposite_2000 = systemfit(eqns_opposite, method = "SUR", 
                                    data = nonparents_est_data_2000)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_unres_r_opposite_2000 = systemfit(eqns_opposite, method = "SUR", 
                                      data = nonparents_est_data_2000)

### Restricted coefficients, deviations from average with own sex

# leisure including eating, drinking, washing
nonparents_res_within_2000 = systemfit(eqns_within, method = "SUR", 
                                data = nonparents_est_data_2000,
                                restrict.regMat = modReg_within)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_res_r_within_2000 = systemfit(eqns_r_within, method = "SUR", 
                                  data = nonparents_est_data_2000, 
                                  restrict.regMat = modReg_within)
...
# leisure including eating, drinking, washing
nonparents_res_between_2000 = systemfit(eqns_between, method = "SUR", 
                                 data = nonparents_est_data_2000,
                                 restrict.regMat = modReg_between)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_res_r_between_2000 = systemfit(eqns_r_between, method = "SUR", 
                                   data = nonparents_est_data_2000,
                                   restrict.regMat = modReg_between)
...
# leisure including eating, drinking, washing
nonparents_res_opposite_2000 = systemfit(eqns_opposite, method = "SUR", 
                                  data = nonparents_est_data_2000,
                                  restrict.regMat = modReg_opposite)
# relaxing, socialising, sport, entertainment, and hobbies only
nonparents_res_r_opposite_2000 = systemfit(eqns_r_opposite, method = "SUR", 
                                    data = nonparents_est_data_2000,
                                    restrict.regMat = modReg_opposite)
